...
typedef B16EventCallbackDzwxqn = void Function(B16EventBeanFhifeode b16EventBeanFhifeode);
...
class B16EventHepFjiejizx{
  ...
  b16SendMsgFjijeio(B16EventBeanFhifeode b16EventBeanFhifeode){
  ...
  StreamSubscription<B16EventBeanFhifeode> b16RegisterEventhuejife({
    ...
    return _b16EventBusfjijife.on<B16EventBeanFhifeode>().listen(b16EventCallbackDzwxqn);
  }
}