...
class B16ImagesResultPageVqntza
  ...
  Widget b16BuildContentRuznxe(
    ...
    return GetBuilder<B16ImagesResultControllerKqmwze>(
      builder: (B16ImagesResultControllerKqmwze b16ControllerVqntza) => Column(
        children: [
          _b16TitleHqmwza(b16ControllerVqntza),
          _b16ContentKqnvze(b16ControllerVqntza),
          _b16BottomVqntza(b16ControllerVqntza),
        ],
      ),
    );
  }
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ListView.separated(
            controller: b16controllerKqmxve.b16ThumbnailControllerPqnvze,
            itemCount: b16controllerKqmxve.b16ImagePathsQxnvza.length,
            scrollDirection: Axis.horizontal,
            itemBuilder: (_, b16IndexKqnvze) {
              final b16PageVqntza = b16IndexKqnvze + 1;
              return B16TapGuardViewMfwqke(
                b16OnPressedJkcxwu: () {
                  b16controllerKqmxve.b16SelectImageVqntza(b16IndexKqnvze);
                },
                b16ChildHnqvsa: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      width: 2.w,
                      color:
                          b16controllerKqmxve.b16SelectedIndexKqmwze ==
                              b16IndexKqnvze
                      ...
                      Positioned.fill(
                        child: ClipRRect(
                          ...
                          child: Image.file(
                            File(
                              b16controllerKqmxve
                                  .b16ImagePathsQxnvza[b16IndexKqnvze],
                            ),
                            fit: BoxFit.cover,
        ...
        Row(
          children: [
            B16TapGuardViewMfwqke(
              b16OnPressedJkcxwu: b16controllerKqmxve.clickReplace,
              b16ChildHnqvsa: Container(
                width: 64.w,
                height: 64.w,
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(width: 0.5.w, color: Color(0xffCFD6DC)),
                ),
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    B16AssetImageViewPzrxcu(
                      "b16_retake_icon_jiwodw",
                      b16WidthDtvqpl: 24.w,
            ...
            SizedBox(width: 12.w),
            B16TapGuardViewMfwqke(
              b16OnPressedJkcxwu: b16controllerKqmxve.clickAdd,
              b16ChildHnqvsa: Container(
                width: 64.w,
                height: 64.w,
                alignment: Alignment.center,
  ...
  Widget _b16ContentKqnvze(
    ...
    child: Container(
      ...
      child: PageView.builder(
        controller: b16controllerKqmxve.b16PageControllerHqmwza,
        itemCount: b16controllerKqmxve.b16ImagePathsQxnvza.length,
        onPageChanged: b16controllerKqmxve.b16PageChangedHqmwza,
        itemBuilder: (_, int b16IndexQxnvza) {
          return Image.file(
            File(b16controllerKqmxve.b16ImagePathsQxnvza[b16IndexQxnvza]),
            fit: BoxFit.contain,
            errorBuilder: (_, _, _) => const SizedBox.shrink(),
          );
        },
