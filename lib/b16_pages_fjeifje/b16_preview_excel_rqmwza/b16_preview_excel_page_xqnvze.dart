...
class B16PreviewExcelPageXqnvze
 ...
 @override
  ...
  ) => GetBuilder<B16PreviewExcelControllerMqptza>(
    init: b16ControllerXqnvze,
    global: false,
  ...
  Widget _b16ContentKqnvze(
    B16PreviewExcelControllerMqptza b16ControllerQxmvza,
  ) => Expanded(
    child: Container(
      ...
      child: !b16ControllerQxmvza.b16CanLoadViewerVqntza
          ...
          : ExcelFileView(
              controller: b16ControllerQxmvza.b16ExcelControllerKqnvze,
              ...
              messageBuilder: (_, b16MessagePqmxza) => Center(
                child: B16LocalizedTextViewCxmpra(
                  File(
                        b16ControllerQxmvza.b16FileInfoXqnvze.path ?? '',
                      ).existsSync()
  ...
  Widget _b16TitleHqmwza(B16PreviewExcelControllerMqptza b16ControllerQxmvza) =>
      Container(
        width: double.infinity,
        color: Colors.white,
        child: SafeArea(
