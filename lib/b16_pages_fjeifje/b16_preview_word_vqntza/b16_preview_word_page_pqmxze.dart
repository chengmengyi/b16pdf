...
class B16PreviewWordPagePqmxze
  ...
  Widget b16BuildContentRuznxe(
    ...
    children: [
      _titleWidget(b16ControllerPqmxze),
      _contentWidget(),
      _bottomWidget(),
    ],
  );
  ...
  _titleWidget(B16PreviewWordControllerCqnvra b16controllerPqmxze)=>Container(
    width: double.infinity,
    color: Colors.white,
    child: SafeArea(
      top: true,
      ...
      child: SizedBox(
        ...
        child: Stack(
          children: [
            ...
            Align(
              child: B16LocalizedTextViewCxmpra("profile.docx",b16FontSizeRvxqle: 18.sp,b16ColorDtkzma: Colors.black,b16FontWeightHncysp: FontWeight.bold,),
            ),
          ],
        ),
      ),
