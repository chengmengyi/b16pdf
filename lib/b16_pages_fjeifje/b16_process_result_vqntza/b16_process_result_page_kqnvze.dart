...
class B16ProcessResultPageKqnvze
    ...
    return Column(
      children: [
        ...
        B16AssetImageViewPzrxcu(
          "b16_process_result_top_ejwoeow",
          b16WidthDtvqpl: 80.w,
        ...
        _infoWidget(b16ControllerKqmxve),
        Spacer(),
  ...
  Widget _bottomWidget(B16ProcessResultControllerHqmwze b16controllerKqmxve) =>
      B16TapGuardViewMfwqke(
        b16OnPressedJkcxwu: b16controllerKqmxve.clickOpen,
  ...
  Widget _infoWidget(B16ProcessResultControllerHqmwze b16controllerKqmxve) =>
      Container(
        width: double.infinity,
        height: 72.h,
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  B16LocalizedTextViewCxmpra(
                    b16controllerKqmxve.b16FileNameVqntza,
                    b16FontSizeRvxqle: 14.sp,
                    b16ColorDtkzma: Colors.black,
                    b16FontWeightHncysp: FontWeight.bold,
                  ...
                  B16LocalizedTextViewCxmpra(
                    b16controllerKqmxve.b16FileDetailHqmwza,
