  ...
  Widget b16BuildContentRuznxe(
    ...
    return Column(
      children: [
        ...
        B16LottieWidgetIjowok(name: "procss",width: 140.w,height: 140.w,repeat: true,),
        SizedBox(height: 50.h,),
        B16LocalizedTextViewCxmpra('PDF Merging...',b16FontSizeRvxqle: 24.sp,b16ColorDtkzma: Colors.black,b16FontWeightHncysp: FontWeight.bold,),
        SizedBox(height: 12.h,),
        B16LocalizedTextViewCxmpra('Please do not close the app.',b16FontSizeRvxqle: 14.sp,b16ColorDtkzma: Color(0xff4B5156),b16FontWeightHncysp: FontWeight.w500,),
        B16LocalizedTextViewCxmpra('processed 2/2 images',b16FontSizeRvxqle: 14.sp,b16ColorDtkzma: Color(0xff4B5156),b16FontWeightHncysp: FontWeight.w500,),
        SizedBox(height: 50.h,),
        Container(
          width: 236.w,
          height: 16.h,
        ...
        B16LocalizedTextViewCxmpra("100%",b16FontSizeRvxqle: 14.sp,b16ColorDtkzma: Color(0xffF4411F),b16FontWeightHncysp: FontWeight.w500,),
      ],
    );
  }

  Widget _b16TitleHqmwza(B16ProcessWaitingControllerPqnvze b16controllerKqmxve) =>
      Container(
